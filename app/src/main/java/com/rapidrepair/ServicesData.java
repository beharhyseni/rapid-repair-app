...
public class ServicesData {
    ...
    ServicesData(){
        ...
        s5_r.add(r11);
        s5_r.add(r12);
        ServicePost service1 = new ServicePost("Professional Plumbing","I can help you with plumbing needs in the kitchen, bathroom, and basement", "Behar Hyseni", "/image/plumber.jpg",s1_r);
